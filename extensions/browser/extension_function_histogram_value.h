...
enum HistogramValue {
  ...
  //---***FYDEOS BEGIN***---
  NATIVE_WINDOWS_GET = 1426,
  NATIVE_WINDOWS_GETALL = 1427,
  NATIVE_WINDOWS_UPDATE = 1428,
  NATIVE_WINDOWS_REMOVE = 1429,
  NATIVE_WINDOWS_CREATE = 1430,
  APP_MANAGEMENT_GETAPPLIST = 1431,
  APP_MANAGEMENT_INSTALLWEBAPP = 1432,
  APP_MANAGEMENT_INSTALLARCAPP = 1433,
  COMMAND_LINE_HASSWITCH = 1434,
  COMMAND_LINE_REMOVESWITCH = 1435,
  COMMAND_LINE_ADDSWITCH = 1436,
  SHELL_SYNC_EXEC = 1437,
  SHELL_ASYNC_EXEC = 1438,
  SHELL_GET_TASK_STATE = 1439,
  SHELL_GET_TASK_OUTPUT = 1440,
  SHELL_GET_DAEMON_STATE = 1441,
  SHELL_FORCE_CLOSE_TASK = 1442,
  //---***FYDEOS END***---
