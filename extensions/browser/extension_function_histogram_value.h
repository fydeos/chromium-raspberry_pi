...
enum HistogramValue {
  ...
  SEARCH_QUERY = 1499,
  //---***FYDEOS BEGIN***---
  NATIVE_WINDOWS_GET = 1500,
  NATIVE_WINDOWS_GETALL = 1501,
  NATIVE_WINDOWS_UPDATE = 1502,
  NATIVE_WINDOWS_REMOVE = 1503,
  NATIVE_WINDOWS_CREATE = 1504,
  APP_MANAGEMENT_GETAPPLIST = 1505,
  APP_MANAGEMENT_INSTALLWEBAPP = 1506,
  APP_MANAGEMENT_INSTALLARCAPP = 1507,
  COMMAND_LINE_HASSWITCH = 1508,
  COMMAND_LINE_REMOVESWITCH = 1509,
  COMMAND_LINE_ADDSWITCH = 1510,
  SHELL_SYNC_EXEC = 1511,
  SHELL_ASYNC_EXEC = 1512,
  SHELL_GET_TASK_STATE = 1513,
  SHELL_GET_TASK_OUTPUT = 1514,
  SHELL_GET_DAEMON_STATE = 1515,
  SHELL_FORCE_CLOSE_TASK = 1516,
  //---***FYDEOS END***---
