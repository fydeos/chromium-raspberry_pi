...
enum HistogramValue {
  ...
  //---***FYDEOS BEGIN***---
  NATIVE_WINDOWS_GET = 1540,
  NATIVE_WINDOWS_GETALL = 1541,
  NATIVE_WINDOWS_UPDATE = 1542,
  NATIVE_WINDOWS_REMOVE = 1543,
  NATIVE_WINDOWS_CREATE = 1544,
  APP_MANAGEMENT_GETAPPLIST = 1545,
  APP_MANAGEMENT_INSTALLWEBAPP = 1546,
  APP_MANAGEMENT_INSTALLARCAPP = 1547,
  COMMAND_LINE_HASSWITCH = 1548,
  COMMAND_LINE_REMOVESWITCH = 1549,
  COMMAND_LINE_ADDSWITCH = 1550,
  SHELL_SYNC_EXEC = 1551,
  SHELL_ASYNC_EXEC = 1552,
  SHELL_GET_TASK_STATE = 1553,
  SHELL_GET_TASK_OUTPUT = 1554,
  SHELL_GET_DAEMON_STATE = 1555,
  SHELL_FORCE_CLOSE_TASK = 1556,
  APP_MANAGEMENT_GETARCPOLICY = 1557,
  //---***FYDEOS END***---
