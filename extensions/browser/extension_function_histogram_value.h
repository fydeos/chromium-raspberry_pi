...
enum HistogramValue {
  ...
  //---***FYDEOS BEGIN***---
  NATIVE_WINDOWS_GET = 1555,
  NATIVE_WINDOWS_GETALL = 1556,
  NATIVE_WINDOWS_UPDATE = 1557,
  NATIVE_WINDOWS_REMOVE = 1558,
  NATIVE_WINDOWS_CREATE = 1559,
  APP_MANAGEMENT_GETAPPLIST = 1560,
  APP_MANAGEMENT_INSTALLWEBAPP = 1561,
  APP_MANAGEMENT_INSTALLARCAPP = 1562,
  COMMAND_LINE_HASSWITCH = 1563,
  COMMAND_LINE_REMOVESWITCH = 1564,
  COMMAND_LINE_ADDSWITCH = 1565,
  APP_MANAGEMENT_GETARCPOLICY = 1566,
  SHELL_SYNC_EXEC = 1567,
  SHELL_ASYNC_EXEC = 1568,
  SHELL_GET_TASK_STATE = 1569,
  SHELL_GET_TASK_OUTPUT = 1570,
  SHELL_GET_DAEMON_STATE = 1571,
  SHELL_FORCE_CLOSE_TASK = 1572,
  //---***FYDEOS END***---
