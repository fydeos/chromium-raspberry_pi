...
enum HistogramValue {
  ...
  //---***FYDEOS BEGIN***---
  NATIVE_WINDOWS_GET = 1465,
  NATIVE_WINDOWS_GETALL = 1466,
  NATIVE_WINDOWS_UPDATE = 1467,
  NATIVE_WINDOWS_REMOVE = 1468,
  NATIVE_WINDOWS_CREATE = 1469,
  APP_MANAGEMENT_GETAPPLIST = 1470,
  APP_MANAGEMENT_INSTALLWEBAPP = 1471,
  APP_MANAGEMENT_INSTALLARCAPP = 1472,
  COMMAND_LINE_HASSWITCH = 1473,
  COMMAND_LINE_REMOVESWITCH = 1474,
  COMMAND_LINE_ADDSWITCH = 1475,
  SHELL_SYNC_EXEC = 1476,
  SHELL_ASYNC_EXEC = 1477,
  SHELL_GET_TASK_STATE = 1478,
  SHELL_GET_TASK_OUTPUT = 1479,
  SHELL_GET_DAEMON_STATE = 1480,
  SHELL_FORCE_CLOSE_TASK = 1481,
  //---***FYDEOS END***---
